...
int main(int argc, char *argv[])
{
	...
	if     (!strcmp(argv[1], "1")) 		doMC2011 	= true;
	else if(!strcmp(argv[1], "2")) 		doMC2012 	= true;
	else if(!strcmp(argv[1], "3")) 		doggF2011 	= true;
	else if(!strcmp(argv[1], "4")) 		doMix1 		= true;
	else if(!strcmp(argv[1], "5")) 		doMix2 		= true;
	else if(!strcmp(argv[1], "6")) 		doMix3 		= true;
	else if(!strcmp(argv[1], "7")) 		doSpin 		= true;
	else if(!strcmp(argv[1], "8")) 		doSpin2011 	= true;
	else if(!strcmp(argv[1], "9")) 		doWH2011 	= true;
	else if(!strcmp(argv[1], "10")) 	doWH2012 	= true;
	else if(!strcmp(argv[1], "11")) 	doZH2012 	= true;
	else if(!strcmp(argv[1], "12")) 	doMCatNlo 	= true;
	else if(!strcmp(argv[1], "13")) 	dottH2011 	= true;
	else if(!strcmp(argv[1], "14")) 	dottH2012 	= true;
	...
	else if(doMCTest)  			dataFileName.open("DataFile/DataFileZee.txt");	
	...
	// MC Studies
	//cutFlow->printMCInfo(35018);

	// For Debug
	//cutFlow->printDebug(30324);
	//cutFlow->printDebug(30002);
	//cutFlow->printDebug(30003);
	//cutFlow->printDebug(30008);
